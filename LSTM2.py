...
class LSTM(nn.Module) :
    def __init__(self) :
        ...
        self.hidden_size = 64
        self.batch_size = 32
        self.layer1 = LSTMBlock(10,self.hidden_size)
...
def LSTM2_stock_predict(model, ticker,  input_dataframe, output_dataframe) :

    X_dataframe = input_dataframe.loc[ticker]
    y_dataframe = output_dataframe.loc[ticker]

    dataset = LSTMdataset2(X_dataframe, y_dataframe, 8)
    dataset.Preprocess()
