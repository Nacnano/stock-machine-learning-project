...
# Predict function
def GRU1_stock_predict(model, ticker, input_dataframe, output_dataframe) :
    
    X_dataframe = input_dataframe.loc[ticker]
    y_dataframe = output_dataframe.loc[ticker]

    dataset = GRUdataset1(X_dataframe, y_dataframe, 8)
    dataset.Preprocess()
